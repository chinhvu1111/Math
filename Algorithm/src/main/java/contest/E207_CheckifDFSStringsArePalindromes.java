...
public class E207_CheckifDFSStringsArePalindromes {
    public static void main(String[] args) {
        ...
        //Consider an empty string dfsStr, and define a recursive function dfs(int x)
        // that takes a node x as a parameter and performs the following steps in order:
        //
