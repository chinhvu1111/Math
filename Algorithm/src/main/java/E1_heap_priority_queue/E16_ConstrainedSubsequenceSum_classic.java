...
public class E16_ConstrainedSubsequenceSum_classic {
...
//                System.out.printf("%s %s\n", i, i-k-1);
    ...
    public static void main(String[] args) {
        ...
        //4.0, Monotonic Deque
        //** IDEA:
        //- We try to remove (the redundant elements) such that we have (the max heap queue)
        //
        //- We only care the max value of the last k elements.
        //- The element of the heap has the (value, index)
        //- Dequeue structured:
        //
        //Max (Peek <-> Poll()) -> .... -> Min (Last <-> PollLast())
        //
        //- We consider the dequeue as the MAX HEAP (Peek() == Max)
        //  + But we can pop the smaller element dp[queue.peekLast()]<dp[i] because:
        //      + We will add the dp[i] to the dequeue having:
        //          + (Nearer index)
        //          + (Bigger value)
        //  ==> We don't need to care about the elements having:
        //      + Smaller index (Worse)
        //      + Smaller value (Worse)
        //
        //4.1, Optimization
