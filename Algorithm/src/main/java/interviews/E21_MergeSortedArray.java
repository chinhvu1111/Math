...
//        merge(nums1,1, nums2, 1);
        ...
        //
        //** Đề bài:
        //- Merge 2 sorted array dạng không giảm tức là có thể >=
        //- Chú ý case : có 0 trong dãy và 0 ở cuối dãy sẽ khác nhau
        //Ex:
        ...
        //
        //2, Ở bên trên mình đã lựa chọn cách --> clarify data trước.
        //==> Loại bỏ các chữ số 0 ở cuối trước.
        System.out.println("");
    }
}
